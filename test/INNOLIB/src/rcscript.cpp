...
bool CRcScriptHpux::WriteScript(char* pszFileName)
{
	...
	fprintf(fp, "        echo \"Start Agent daemon(%s)\"\n", GetFileName());
	fprintf(fp, "        ;;\n\n");
	fprintf(fp, "stop_msg)\n");
	fprintf(fp, "        echo \"Stopping Agent daemon(%s)\"\n", GetFileName());
	fprintf(fp, "        ;;\n\n");
	fprintf(fp, "'start')\n");
	...
	fprintf(fp, "                echo \"Agent started\"\n");
	fprintf(fp, "        else\n");
	fprintf(fp, "                echo \"Unable to start Agent\"\n");
	fprintf(fp, "        fi\n\n");
	...
	fprintf(fp, "                echo \"Agent stopped\"\n");
	fprintf(fp, "        else\n");
	fprintf(fp, "                echo \"Unable to stop Agent\"\n");
	fprintf(fp, "        fi\n");
	fprintf(fp, "        ;;\n\n");
	fprintf(fp, "*)\n");
	fprintf(fp, "        echo \"usage: $0 {start|stop}\"\n");
